...
class UpdateWeChatToken extends Subscription {
  ...
  async subscribe() {
    ...
    // console.log(11)
     console.log(res);
    this.app.caches.setWeChatData({ accessToken: res.data.access_token });
    res = await this.ctx.curl(
      "https://api.weixin.qq.com/cgi-bin/ticket/getticket",
      {
        data: {
          access_token: this.app.caches.getWeChatData().accessToken,
          type: "jsapi"
        },
        dataType: "json"
      }
    ...
    // console.log(111111)
     console.log(res);
    this.app.caches.setWeChatData({ jsApiTicket: res.data.ticket });
  }
}
